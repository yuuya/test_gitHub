...
{   
    ...
    mainDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"mainDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(mainDataViewController *)viewController];
